...
user_id = "507f191e810c19729de860ea"  # Replace with your user_id
mandatory_ingredients = ["flour", "sugar", "eggs", "butter"]  # Replace with your ingredients
theme = "baking"  # Replace with your theme

# Create the dynamic recipe prompt using f-strings
recipe_prompt = f"""
