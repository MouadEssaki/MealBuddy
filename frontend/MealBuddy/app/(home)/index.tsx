...
import { IconRegistry, ApplicationProvider, Layout, Text, Icon } from '@ui-kitten/components';
          ...
          <Layout style={{ flex: 1, backgroundColor: customTheme.fond }}>
            <ScrollView contentContainerStyle={{ padding: 20, alignItems: "center" }} showsVerticalScrollIndicator={false}>
              <View style={styles.headerContainer}>
                <Text category='h1' style={styles.welcomeText}>Dashboard</Text>
                <Text category='h5' style={styles.welcomeText}>Bonjour, {user} !</Text>
              </View>
              ...
              <View style={styles.cardContainer}>
                ...
                <Text category='h6' style={styles.budgetLabel}>Calorie Budget</Text>
                ...
                >
                  {(fill) => (
                    <View style={styles.progressContent}>
                      <Text style={styles.consumedText}>{Math.round(totalConsumed)}</Text>
                      <Text style={styles.remainingText}>{totalCalories - totalConsumed} left</Text>
                    </View>
                  )}
                </AnimatedCircularProgress>

                <View style={styles.mealsContainer}>
                  <Pressable onPress={() => handleMealPress('Breakfast')} style={styles.mealColumn}>
                    <Text style={styles.mealTitle}>Breakfast</Text>
                    <Text style={styles.mealValue}>{consumedCalories.breakfast}</Text>
                  </Pressable>

                  <Pressable onPress={() => handleMealPress('Lunch')} style={styles.mealColumn}>
                    <Text style={styles.mealTitle}>Lunch</Text>
                    <Text style={styles.mealValue}>{consumedCalories.lunch}</Text>
                  </Pressable>

                  <Pressable onPress={() => handleMealPress('Dinner')} style={styles.mealColumn}>
                ...
                <View style={styles.macrosContainer}>
                  <View style={styles.macroColumn}>
                    ...
                    <Text style={styles.macroValue}>{macros.carbs.consumed}g / {macros.carbs.goal}g</Text>
                    <AnimatedCircularProgress
                      size={50}
                      width={5}
                  ...
                  <View style={styles.macroColumn}>
                    ...
                    <Text style={styles.macroValue}>{macros.protein.consumed}g / {macros.protein.goal}g</Text>
                    <AnimatedCircularProgress
                      size={50}
                      width={5}
                  ...
                  <View style={styles.macroColumn}>
                    ...
                    <Text style={styles.macroValue}>{macros.fat.consumed}g / {macros.fat.goal}g</Text>
                    <AnimatedCircularProgress
                      size={50}
                      width={5}
